...
Level { # population
  Distrib(M_lnFgutabs, Uniform, -4.605, 0);
  Distrib(M_lnkgutelim, Normal, -1.05, 1.15);
  Distrib(M_lnkmtot, TruncNormal, -2.26, 1.15, -4.56, 0.049);
  Distrib(M_lnkmratio, Normal, 0, 1.15);
  Distrib(M_lnkeD, Normal, -2.45, 1.15);

  Distrib(SD_lnFgutabs, HalfNormal, 0.2);
  Distrib(SD_lnkgutelim, HalfNormal, 0.2); 
  Distrib(SD_lnkmtot, HalfNormal, 0.2);
  Distrib(SD_lnkmratio, HalfNormal, 0.2);
  Distrib(SD_lnkeD, HalfNormal, 0.2);
...
Level { # individual
  ...
  Distrib(lnkmtot, Normal, 0, 1);
  Distrib(lnkmratio, Normal, 0, 1);
  Distrib(lnkeD, Normal, 0, 1);
